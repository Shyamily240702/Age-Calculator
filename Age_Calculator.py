...
if __name__ == "__main__" :
	...
	# Create a Day : label
	day = Label(gui, text = "Date", bg = "light green")
	...
	givenDay = Label(gui, text = "Given Date", bg = "light green")
	...
	resultantAge = Button(gui, text = "Resultant Age", fg = "Black", bg = "violet", command = calculateAge)

	# Create a Clear All Button and attached to clearAll function
	clearAllEntry = Button(gui, text = "Clear All", fg = "Black", bg = "violet", command = clearAll)
